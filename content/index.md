...
- The current development of RookDB primarily focuses on the **[Storage Engine - RookDB](./storage-engine/Introduction.md)**, which handles data organization, storage structures, Catalog Manager, Buffer Manager, Table layout, Page Layout and Tuple Layout. For a high-level understanding of the system workflow and components, refer to the architecture figure below.
...
- Crate: [rook-parser](https://crates.io/crates/rook-parser)
...
- Documentation: [RookDB Docs](./storage-engine/Introduction.md)
- Crate: [storage-manager](https://crates.io/crates/storage_manager)
